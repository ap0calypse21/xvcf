...
void DESC::SendHWIDStatusPacket(BYTE bStatus, BYTE bValid1, BYTE bValid2, BYTE bValid3, BYTE bValid4, BYTE bValid5)
{
	TPacketGCHWID HWIDPacket;
	HWIDPacket.bHeader = HEADER_GC_HWID;
#if defined(__DISABLE_PIN_SYSTEM__)
	HWIDPacket.bStatus = 0;
	HWIDPacket.bVerifiedPIN[0] = 1;
	HWIDPacket.bVerifiedPIN[1] = 1;
	HWIDPacket.bVerifiedPIN[2] = 1;
	HWIDPacket.bVerifiedPIN[3] = 1;
	HWIDPacket.bVerifiedPIN[4] = 1;
#else
	HWIDPacket.bStatus = bStatus;
	HWIDPacket.bVerifiedPIN[0] = bValid1;
	HWIDPacket.bVerifiedPIN[1] = bValid2;
	HWIDPacket.bVerifiedPIN[2] = bValid3;
	HWIDPacket.bVerifiedPIN[3] = bValid4;
	HWIDPacket.bVerifiedPIN[4] = bValid5;
#endif
	Packet(&HWIDPacket, sizeof(TPacketGCHWID));
}
